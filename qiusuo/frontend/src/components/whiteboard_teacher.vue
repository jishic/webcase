...
<script>
	...
	export default {
		...
		created() {
	        ...
	        var session = signal.login("wwk3", "_no_need_token");
	        var vm = this;
	        session.onLoginSuccess = function(uid){
	            vm.channel = session.channelJoin("123");
		...
		methods: {
				...
				switch(style)
				{
					...
					case 0:
						document.onmousemove=function(e){		
							...
							myArray[5] = mycolor;
							myArray[6] = mywidth;
							vm.channel.messageChannelSend(myArray);
							beginx =e.offsetX;
							beginy =e.offsetY;
						}
						break;
			...
			clear(){
				...
				myArray[5] = 0;
				myArray[6] = 0;
				this.channel.messageChannelSend(myArray);
