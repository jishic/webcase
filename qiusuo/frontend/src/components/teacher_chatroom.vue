...
export default {
    ...
    methods:{
        sentMessage:function(){
            ...
            this.goEasy.publish({
                channel:'102596',
                message:'<div class="all_content"><p>'+myDate.toLocaleString()+'</p><img src="'+this.imgURL+'" class="shape"><div class="content"><div class="content_word_tea">'+this.input_text+'</div></div></div>'
                });
